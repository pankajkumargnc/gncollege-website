const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StaffPage-D2Ijt6PM.js","assets/vendor-react-CzOzt2PS.js","assets/page-gallery-DNLXrQFz.js","assets/vendor-firebase-CQO6Ah9N.js","assets/DepartmentPage-ndiYdwKt.js","assets/page-about-D6frE1KF.js","assets/page-about-DlOOvLVT.css","assets/NewsPage-BgA7HhNa.js","assets/vendor-admin-D6IP6iy7.js","assets/vendor-admin-_rRfbp4A.css","assets/NotificationsPage-C8kJTkL3.js","assets/DocumentsPage-BTz38VLm.js","assets/EventsPage-DPKJyPCp.js","assets/chunk-admin-D-0VY8_W.js","assets/Ticker--0ScjVmp.js","assets/page-academics-DAw_MrFd.js","assets/page-admission-i6KGRcmi.js","assets/page-naac-D4oSiITq.js","assets/page-publication-Cx2LXeBl.js","assets/page-activity-kufJTwBV.js","assets/page-campus-BEd6n1vv.js"])))=>i.map(i=>d[i]);
var Je=Object.defineProperty,Qe=Object.defineProperties;var Ze=Object.getOwnPropertyDescriptors;var De=Object.getOwnPropertySymbols;var et=Object.prototype.hasOwnProperty,tt=Object.prototype.propertyIsEnumerable;var ue=(t,n,i)=>n in t?Je(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,D=(t,n)=>{for(var i in n||(n={}))et.call(n,i)&&ue(t,i,n[i]);if(De)for(var i of De(n))tt.call(n,i)&&ue(t,i,n[i]);return t},F=(t,n)=>Qe(t,Ze(n));var be=(t,n,i)=>ue(t,typeof n!="symbol"?n+"":n,i);var Me=(t,n,i)=>new Promise((o,l)=>{var x=g=>{try{m(i.next(g))}catch(r){l(r)}},p=g=>{try{m(i.throw(g))}catch(r){l(r)}},m=g=>g.done?o(g.value):Promise.resolve(g.value).then(x,p);m((i=i.apply(t,n)).next())});import{r as s,j as e,L as _,u as Ce,R as Ae,c as at,F as nt,d as it,e as c,f as st,H as rt}from"./vendor-react-CzOzt2PS.js";import{_ as P}from"./chunk-admin-D-0VY8_W.js";import{C as b}from"./page-gallery-DNLXrQFz.js";import{q as xe,o as fe,c as ge,d as H,a as U,b as Ee}from"./vendor-firebase-CQO6Ah9N.js";import{p as ot}from"./vendor-admin-D6IP6iy7.js";import"./page-about-D6frE1KF.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const x of l)if(x.type==="childList")for(const p of x.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&o(p)}).observe(document,{childList:!0,subtree:!0});function i(l){const x={};return l.integrity&&(x.integrity=l.integrity),l.referrerPolicy&&(x.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?x.credentials="include":l.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function o(l){if(l.ep)return;l.ep=!0;const x=i(l);fetch(l.href,x)}})();const lt="917903340991",ct="Namaste! Main Guru Nanak College ke baare mein jaankari chahta hoon.";function dt(){const[t,n]=s.useState(!1),i=`https://wa.me/${lt}?text=${encodeURIComponent(ct)}`;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        @keyframes wa-pulse {
