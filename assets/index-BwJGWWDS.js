const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StaffPage-Um0BH6Du.js","assets/vendor-react-CzOzt2PS.js","assets/page-gallery-BJH3vJa4.js","assets/vendor-firebase-BJj4R8JZ.js","assets/DepartmentPage-CiOgQHo0.js","assets/page-about-BC-xl8ed.js","assets/page-about-BjgwLtep.css","assets/NewsPage-Ve29_RMs.js","assets/vendor-admin-D6IP6iy7.js","assets/vendor-admin-_rRfbp4A.css","assets/NotificationsPage-D8jROqJn.js","assets/DocumentsPage-DQl23_dU.js","assets/EventsPage-DENqDMTz.js","assets/chunk-admin-4CdM5lnk.js","assets/Ticker-fW5KBQeO.js","assets/page-academics-CMvlKc1i.js","assets/page-admission-TFR2SIDx.js","assets/page-naac-BF33Cedz.js","assets/page-publication-C7zc-pPb.js","assets/page-activity-DkVF9RkC.js","assets/page-campus-C8PE1fRB.js"])))=>i.map(i=>d[i]);
var Je=Object.defineProperty,Qe=Object.defineProperties;var Ze=Object.getOwnPropertyDescriptors;var De=Object.getOwnPropertySymbols;var et=Object.prototype.hasOwnProperty,tt=Object.prototype.propertyIsEnumerable;var ue=(t,n,i)=>n in t?Je(t,n,{enumerable:!0,configurable:!0,writable:!0,value:i}):t[n]=i,D=(t,n)=>{for(var i in n||(n={}))et.call(n,i)&&ue(t,i,n[i]);if(De)for(var i of De(n))tt.call(n,i)&&ue(t,i,n[i]);return t},F=(t,n)=>Qe(t,Ze(n));var be=(t,n,i)=>ue(t,typeof n!="symbol"?n+"":n,i);var Me=(t,n,i)=>new Promise((o,l)=>{var x=g=>{try{m(i.next(g))}catch(r){l(r)}},p=g=>{try{m(i.throw(g))}catch(r){l(r)}},m=g=>g.done?o(g.value):Promise.resolve(g.value).then(x,p);m((i=i.apply(t,n)).next())});import{r as s,j as e,L as _,u as Ce,R as Ae,c as at,F as nt,d as it,e as c,f as st,H as rt}from"./vendor-react-CzOzt2PS.js";import{_ as P}from"./chunk-admin-4CdM5lnk.js";import{C as b}from"./page-gallery-BJH3vJa4.js";import{q as xe,o as fe,c as ge,d as H,a as U,b as Ee}from"./vendor-firebase-BJj4R8JZ.js";import{p as ot}from"./vendor-admin-D6IP6iy7.js";import"./page-about-BC-xl8ed.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const x of l)if(x.type==="childList")for(const p of x.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&o(p)}).observe(document,{childList:!0,subtree:!0});function i(l){const x={};return l.integrity&&(x.integrity=l.integrity),l.referrerPolicy&&(x.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?x.credentials="include":l.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function o(l){if(l.ep)return;l.ep=!0;const x=i(l);fetch(l.href,x)}})();const lt="917903340991",ct="Namaste! Main Guru Nanak College ke baare mein jaankari chahta hoon.";function dt(){const[t,n]=s.useState(!1),i=`https://wa.me/${lt}?text=${encodeURIComponent(ct)}`;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
        @keyframes wa-pulse {
