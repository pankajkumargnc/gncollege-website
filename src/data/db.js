...
export const GALLERY_CATEGORIES = ['All Events', 'Recent Programs', 'Cultural Activity', 'NSS Programs', 'Departments']
...
export const departments = [
  { name: 'Department of Commerce',        emoji: '💼', desc: 'B.Com (Hons & Gen)',                  color: '#3498db' },
  { name: 'Humanities & Social Science',   emoji: '📖', desc: 'B.A. in multiple disciplines',        color: '#e74c3c' },
  { name: 'Computer Science (BCA)',        emoji: '💻', desc: 'Bachelor of Computer Applications',   color: '#27ae60' },
  { name: 'Business Administration (BBA)', emoji: '📊', desc: 'Bachelor of Business Administration', color: '#9b59b6' },
]
...
// src/data/db.js me navLinks array ko is se replace karein
...
export const navLinks = [
  { label: 'Home', href: '/' },
  {
    ...
    sub: [
      ...
      { label: 'Principal Message', href: '/about-us/principal-message' },
      {
        ...
        sub: [{ label: 'Organogram', href: '/about-us/college-management/organogram' }, { label: 'Presidents', href: '/about-us/college-management/presidents' }, { label: 'Secretaries', href: '/about-us/college-management/secretaries' }, { label: 'Principal', href: '/about-us/college-management/principal' }]
      },
      {
      ...
      {
        label: 'College Staff',
        sub: [{ label: 'Teaching Staff', href: '/about-us/college-staff/teaching-staff' }, { label: 'Non-Teaching Staff', href: '/about-us/college-staff/non-teaching-staff' }]
      },
      {
        label: 'Regulations',
        sub: [
  ...
  },
  {
    ...
    href: '/',
    sub: [
      { label: 'Campus Visuals', sub: [{ label: 'Bhuda', href: '/campus/visuals/bhuda' }, { label: 'Bank More', href: '/campus/visuals/bank-more' }, { label: 'Vocational Building', href: '/campus/visuals/vocational-building' }] },
  ...
  },
  {
    ...
    sub: [
      ...
      { label: 'Departments', sub: [{ label: 'Humanities', href: '/academics/departments/humanities' }, { label: 'Social Science', href: '/academics/departments/social-science' }, { label: 'Commerce', href: '/academics/departments/commerce' }, { label: 'BCA', href: '/academics/departments/bca' }, { label: 'BBA', href: '/academics/departments/bba' }] },
  ...
  },
  {
    ...
    sub: [
      ...
      { label: 'Notification', sub: [{ label: 'Latest', href: '/admission/notification/latest' }, { label: 'Upcoming News', href: '/admission/notification/upcoming' }] },
  ...
  },
  {
    ...
    sub: [
      ...
      { label: 'Collaboration', sub: [{ label: 'Rotaract Club', href: '/activity/collaboration/rotaract-club' }, { label: 'Sadbhavana Diwas', href: '/activity/collaboration/sadbhavana-diwas' }] }
    ]
  },
  {
    label: 'NAAC',
    href: '/',
    sub: [
      { label: 'SSR 1st Cycle', sub: [{ label: 'Cycle 1 Documents', href: '/naac/ssr-1st-cycle/cycle-1-documents' }, { label: 'Peer Team Report', href: '/naac/ssr-1st-cycle/peer-team-report' }] },
      { label: 'SSR 2nd Cycle', sub: [{ label: 'Cycle 2 Documents', href: '/naac/ssr-2nd-cycle/cycle-2-documents' }, { label: 'Executive Summary', href: '/naac/ssr-2nd-cycle/executive-summary' }] },
  ...
  },
  {
    ...
    sub: [
      ...
      { label: 'Examination Results', sub: [{ label: 'Result 2024', href: '/publication/examination-results/2024' }, { label: 'Result 2023', href: '/publication/examination-results/2023' }] },
      { label: 'SSS Report', sub: [{ label: 'Report 2023-24', href: '/publication/sss-report/2023-24' }, { label: 'Report 2022-23', href: '/publication/sss-report/2022-23' }] }
    ]
  },
...
export const sliderSlides = [
  { text: '🏆 Winner - 4th Inter-College Youth Festival' },
  { text: '🎓 Admission 2024-28 Now Open - Apply Today!' },
  { text: '✅ NAAC Accredited Institution - Excellence in Education' },
  { text: '💻 AICTE Approved BCA & BBA Courses Available' },
  { text: '📚 Affiliated to B.B.M.K. University, Dhanbad' },
]
