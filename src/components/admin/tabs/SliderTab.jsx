...
// ✅ BUG FIX: slideData → formData, setSlideData → setFormData
    ...
    <div className="fade-up">
      ...
      <div className="card-gold">
        ...
        <form onSubmit={save}>
          ...
          {/* ✅ FIX: slideData → formData, setSlideData → setFormData */}
          ...
          {sorted.map((s, idx) => (
            <div key={s.id} style={{ borderRadius: 14, overflow: 'hidden', border: `2px solid ${s.isActive ? GOLD : T.b1}`, opacity: s.isActive ? 1 : 0.5 }}>
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', top: 8, left: 8, background: NAVY, color: 'white', borderRadius: 6, padding: '2px 8px', fontSize: 11, fontWeight: 900 }}>
                  #{idx + 1}
                </div>
              ...
              <div style={{ padding: 14, background: 'white' }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
                  <button className="abtn abtn-outline abtn-sm" style={{ flex: 1 }}
                    onClick={() => {
                      setEditItem(s);
                      setFormData({
                        title:    s.title    || '',
