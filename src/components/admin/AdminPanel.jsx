...
class AdminErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) return (
      <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100dvh', width:'100vw', position:'fixed', top:0, left:0, zIndex:99999, background:'#0f2347', flexDirection:'column', gap:16 }}>
