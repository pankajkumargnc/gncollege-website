...
/* ─── Shared Document List (For Results, Magazine, SSS) ─── */
      ...
      {docs.length === 0 ? (
        ...
        docs.map((d, i) => (
          <Fade key={d.id} delay={i * 0.05}>
            <a href={d.link} target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 14, padding: 20, background: '#fff', borderRadius: 16, border: '1.5px solid #e2e8f0', textDecoration: 'none', color: NAVY }}>
...
/* ════════════════════════════════════════════════════════════
   2. E-MAGAZINE / RESULTS / SSS REPORT
════════════════════════════════════════════════════════════ */
